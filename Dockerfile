...
# Retrieve the compiled shared library from debian
ENV DEBVER=30.2-1
RUN wget http://ftp.fr.debian.org/debian/pool/main/n/ngspice/libngspice0_${DEBVER}_amd64.deb
RUN wget http://ftp.fr.debian.org/debian/pool/main/n/ngspice/libngspice0-dev_${DEBVER}_amd64.deb
